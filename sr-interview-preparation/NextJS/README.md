...
| File | Topics |
|------|--------|
| `nextjs-app-router.md` | App Router vs Pages Router, Server vs Client Components, Server Actions, file-based routing, layouts, templates, route groups, parallel routes, intercepting routes, loading UI, error handling, Middleware, next/link prefetching |
